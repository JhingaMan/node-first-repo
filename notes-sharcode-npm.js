...
// package-lock json is so that if any other person is trying to download code and use npm init he or she should get the same version of all dependencies 
// all dependencies version are mentioned in package-lock.json